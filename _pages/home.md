...
![ai4shipwrecks_flowchart](/assets/images/ai4shipwrecks_flowchart.png){: width="200"}
...
![gpr_flowchart](/assets/images/gpr_flowchart.png){: width="120"}
...
![colocation_flowchart](/assets/images/colocation_flowchart.png){: width="180"}
