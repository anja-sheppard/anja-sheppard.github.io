...
![ai4shipwrecks_flowchart](/assets/images/ai4shipwrecks_flowchart.png){:width="55%"}(https://journals.sagepub.com/doi/abs/10.1177/02783649241266853){:target="_blank"}
...
![gpr_flowchart](/assets/images/gpr_flowchart.png){:width="55%"}(https://openaccess.thecvf.com/content/CVPR2024W/PBVS/html/Sheppard_Learning_Surface_Terrain_Classifications_from_Ground_Penetrating_Radar_CVPRW_2024_paper.html){:target="_blank"}
...
![colocation_flowchart](/assets/images/colocation_flowchart.png){:width="55%"}(https://arxiv.org/abs/2310.01932){:target="_blank"}
